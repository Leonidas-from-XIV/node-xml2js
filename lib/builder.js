  ...
  exports.Builder = (function() {
    ...
    Builder.prototype.buildObject = function(rootObj) {
      ...
      if ((Object.keys(rootObj).length === 1) && (this.options.rootName === defaults['0.2'].rootName)) {
        ...
        rootName = this.options.propNameProcessors ? processItem(this.options.propNameProcessors, rootName) : rootName;
      } else {
        ...
        return function(element, obj) {
          ...
          if (typeof obj !== 'object') {
            ...
            for (index in obj) {
              ...
              for (key in child) {
                entry = child[key];
                tag = _this.options.propNameProcessors ? processItem(_this.options.propNameProcessors, key) : key;
