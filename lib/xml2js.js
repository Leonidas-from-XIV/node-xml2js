  ...
  exports.Parser = (function(_super) {
    ...
    Parser.prototype.reset = function() {
      ...
      this.saxParser.onopentag = function(node) {
        ...
        if (_this.options.normalizeTags)
          obj["#name"] = node.name.toLowerCase();
        else if (_this.options.lowerCamelCaseTags)
          obj["#name"] = node.name.charAt(0).toLowerCase() + node.name.slice(1);
        else
          obj["#name"] = node.name;
