        ...
        if (!_this.options.ignoreAttrs) {
          ...
          for (key in _ref) {
            ...
            if (_this.options.mergeAttrs) {
              obj[key.replace(prefixMatch ,'')] = node.attributes[key];
            } else {
              obj[attrkey][key.replace(prefixMatch ,'')] = node.attributes[key];
            }
          }
        }
        if (_this.options.stripPrefix) {
        	obj["#name"] = (_this.options.normalizeTags ? node.name.toLowerCase() : node.name).replace(prefixMatch,'');	
        } else {
